...
Faça esse curso de Agilidade e:
...
Aulas
O que é Scrum?  Ver primeiro vídeo
1 / 9
17min
Scrum Framework
0 / 7
...
@@02
Para saber mais: slides do curso

Boas-vindas!
Tudo pronto para começar o curso Scrum: agilidade em seu projeto?

Para melhor acompanhamento dos vídeos, das atividades e para você retomar o aprendizado adquirido após conquistar o certificado de conclusão da Alura, no link a seguir, você pode fazer download do arquivo PDF com os slides do curso por meio deste link.

Bons estudos!

https://cdn3.gnarususercontent.com.br/2993-scrum-agilidade-seu-projeto/Alura-PDF-Slides-Scrum-Agilidade+em+seus+projetos.pdf
...
Execução
Inspeção
Adaptações eventuais na solução
...
@@04
Para saber mais: livros sobre Scrum
...
Livro Scrum: Gestão ágil para produtos de sucesso, do autor Rafael Sabbagh.
Livro Scrum 360: Um guia completo e prático de agilidade, do autor Jorge Audy. Nesses dois livros, você encontrará boas práticas e técnicas complementares ao Scrum Guide, trazidas a partir da experiência de mercado de ambos os autores.
Livro Scrum: A arte de fazer o dobro do trabalho na metade do tempo, dos autores Jeff e J.J. Sutherland. Essa leitura é importante, pois foi o primeiro livro sobre o tema, sendo essencial para aqueles que desejam compreender e aplicar a metodologia Scrum de forma eficaz, possibilitando o aumento da produtividade e a entrega de resultados significativos em projetos.
Em cada um desses livros você perceberá o Scrum de forma mais aprofundada, conhecendo também algumas dicas de como aplicá-lo em seus projetos a partir da experiência validada dos autores. Boa leitura!

https://www.casadocodigo.com.br/products/livro-scrum

https://www.casadocodigo.com.br/products/livro-scrum-360

https://www.google.com/search?q=Scrum:+A+arte+de+fazer+o+dobro+do+trabalho+na+metade+do+tempo&rlz=1C1CHZN_pt-BRBR970BR970&sxsrf=APwXEdeZcx-lRZOcLv6JgtjgbjLrdK7tsQ:1681846218578&source=lnms&sa=X&ved=0ahUKEwiIzrKzlbT-AhWZrJUCHbMdBqIQ_AUIwAcoAA&biw=1536&bih=746&dpr=1.25

@@05
Scrum aplicado em negócios
...
@@06
Para saber mais: scrum além da área de tech

Neste episódio do podcast Hipsters os convidados discutem como Scrum pode ser utilizado em outros contextos além do desenvolvimento de software. Além disso, comentam como o framework pode ser útil no processo de transformação digital dos negócios.
Que tal apertar o play e conectar com o conteúdo estudado nesta aula? Confira, então, o episódio Scrum e Agile para além de Tecnologia por meio deste link.

https://www.alura.com.br/podcast/hipsterstech-scrum-e-agile-para-alem-de-tecnologia-hipsters-115-a467

@@07
Principal diferencial do Scrum
...
O diferencial do Scrum é ser um modelo iterativo, em que o andamento do processo de trabalho flui de cima para baixo, como uma cascata, em que cada fase do projeto é sequencial, até a entrega do produto.
...
Alternativa incorreta
O diferencial do Scrum é ser um modelo iterativo, em que o processo de trabalho consiste em, primeiro, realizar um amplo planejamento de projeto e, só depois, executar tudo o que foi planejado, entregando o produto para a pessoa cliente/usuário.
 
Alternativa incorreta
O diferencial do Scrum é ser um modelo waterfall, em que o processo de trabalho é mais dinâmico e flexível, permitindo um aprimoramento do produto durante o seu desenvolvimento.

@@08
Desafio: aplicando Scrum no seu contexto

Imagine uma empresa de moda chamada FashionTrend, que projeta e fabrica roupas para o mercado de moda feminina. Essa empresa estava enfrentando desafios em sua cadeia de suprimentos, incluindo atrasos na produção, estoques excessivos e dificuldades na comunicação entre as equipes de design, produção e logística. Assim, decidiu implementar o framework Scrum para solucionar esses problemas.
Com a implementação do Scrum, a FashionTrend conseguiu reduzir os atrasos na produção das roupas, pois a equipe de produção passou a ter uma percepção mais clara dos pedidos a serem produzidos em cada sprint além de otimizar o seu estoque, pois um product backlog sempre atualizado impulsionou uma melhor gestão dos materiais e insumos necessários para a produção de roupas.

Por fim, houve uma grande melhora na comunicação entre os diferentes setores do negócio, pois os eventos do Scrum permitiram que as equipes compartilhassem informações sobre o progresso do trabalho, identificassem gargalos e os resolvessem rapidamente.

Agora é com você!

Com base no exemplo apresentado e no que você aprendeu nesta aula:
Identifique e descreva algum problema que pode ser resolvido com Scrum no seu trabalho ou em projetos pessoais;
Justifique porque você acha que o problema escolhido pode ser resolvido aplicando o framework scrum.
Lembre-se de que, quando tratamos de um problema, estamos nos referindo a alguma situação, produto, serviço, processo etc. Caso sinta-se confortável, compartilhe a sua resposta no nosso canal do Discord Alura.

Opinião do instrutor

De acordo com o que você pôde estudar, o Scrum pode ser usado em diversos âmbitos e cenários, seja pessoal, acadêmico e corporativo. Supondo o uso do Scrum no âmbito corporativo, imagine que uma determinada empresa esteja tentando melhorar a experiência de atendimento de seus clientes, pois está recebendo muitas reclamações. Uma experiência ruim é um problema complexo, uma vez que existem diferentes percepções a respeito de um bom atendimento, assim como existem diferentes pessoas envolvidas em um atendimento ao cliente (o próprio atendente, o gestor desse colaborador, o cliente etc.).
Nesse caso, o Scrum é um ótimo meio para resolver esse problema, já que o atendimento precisa ser alterado logo, de forma ágil, para que a empresa não seja prejudicada por uma má reputação. Além disso, por envolver diferentes pessoas, esse problema (experiência de atendimento ruim), precisa ser resolvido juntando todas essas pessoas. Logo, o Scrum oferece uma estrutura para enfrentar problemas complexos de forma colaborativa, transparente e com foco na entrega de valor aos clientes.

Como você pôde observar, existe uma gama de situações em que o Scrum pode ser aplicado para resolver problemas, por isso, certamente, a sua resposta foi diferente dessa. O mais importante é você aprender a identificar em quais situações o Scrum consegue ser utilizado. Ou seja, em que tipos de problemas ou projetos ele pode ser usado e trazer bons resultados.
